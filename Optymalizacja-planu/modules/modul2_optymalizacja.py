...
class AlgorytmWyzarzania:
    def __init__(self, stan_planu, lista_zajec, prowadzacy_db, sale_db):
        ...
        self.KARA_KRYTYCZNA_PENSUM = 5000 
        self.WAGA_NIECHETNIE = 200        
        self.WAGA_BALANSU_GODZIN = 80     
        self.WAGA_OKIENKO = 50            
        self.WAGA_SC3_PRZEDMIOT = 50     
        self.WAGA_SC4_ROWNOMIERNE = 10    
        self.WAGA_SC5_LOKALIZACJA = 10    
